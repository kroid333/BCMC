...
public class MagicTextView extends TextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.MagicTextView_backgroundMagic)){
				Drawable background = a.getDrawable(R.styleable.MagicTextView_backgroundMagic);
				if(background != null){
					this.setBackgroundDrawable(background);
				}else{
					this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_backgroundMagic, 0xff000000));
				}
			}
